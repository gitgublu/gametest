...
minetest.register_on_joinplayer(function(player)
	minetest.show_formspec(player:get_player_name(), "morenodes:hello", "formspec_version[4]size[10,10]label[0,0.3;Bienvenue dans votre vesseau spatiale! vous devez]label[0,0.8;retourner sur Terre. Pour se faire, vous devez produire]label[0,1.3;du bio carburant à base de plantes. Utilisez]label[0,1.8;la rafinerie pour cela. Ensuite, introduisez le carburant]label[0,2.3;dans les réacteurs. Bonne chance]button_exit[3.5,9;3,1;quit;ok]")
end)
